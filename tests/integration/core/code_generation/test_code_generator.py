...
def test_math_function_generation(function_generator, mock_responses):
    ...
    with patch('evolia.core.code_generator.call_openai_structured', return_value=mock_responses["math_function"]):
...
def test_string_processing_function(function_generator, mock_responses):
    ...
    with patch('evolia.core.code_generator.call_openai_structured', return_value=mock_responses["string_function"]):
        response = function_generator.generate_function(
...
def test_complex_function_generation(function_generator, mock_responses):
    ...
    with patch('evolia.core.code_generator.call_openai_structured', return_value=mock_responses["complex_function"]):
        response = function_generator.generate_function(
