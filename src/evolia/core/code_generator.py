...
class CodeGenerator:
    ...
    def __init__(self, config: Optional[CodeGenerationConfig] = None):
        ...
        logger.debug("Initialized CodeGenerator", extra={
            'payload': {
    ...
    def generate(self, prompt_template: str, template_vars: Dict[str, Any], schema: Dict[str, Any], system_prompt: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            processed_response = {
                "code": response["code"],
                "function_name": response.get("function_name", template_vars.get("function_name", "auto_generated")),
