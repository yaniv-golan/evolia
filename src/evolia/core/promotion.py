...
class ToolPromoter:
    ...
    def promote_candidate_to_system(self, 
                                  candidate_path: str,
        ...
        tools.append({
            ...
            "description": description or f"Promoted from candidate {candidate_metadata['name']}",
            ...
            "promotion_stats": {
                ...
                "success_ratio": candidate_metadata["success_count"] / candidate_metadata["usage_count"]
            }
        })
