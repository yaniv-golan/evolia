...
class CandidateManager:
    ...
    def move_to_candidates(
        self, ephemeral_file_path: str, auto_promote: bool = False
    ) -> str:
        """
    ...
    def check_promotion_eligibility(
        self, usage_threshold: int = 3, success_ratio_threshold: float = 0.8
    ) -> List[str]:
        """
        ...
        for candidate in candidates:
            ...
            if (
                ...
                and (success / usage) >= success_ratio_threshold
            ):
